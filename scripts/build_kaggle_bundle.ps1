param(
    [ValidateSet('smoke','phase1','smoke_v2','phase1_v2','phase2_smoke','phase2','phase25_smoke','phase25','phase275_smoke','phase275','phase3_smoke','phase3_smoke_vast','phase3_dynamic_smoke_vast','phase3')]
...
$stagingName = if ($Profile -eq 'phase3_dynamic_smoke_vast') { 'dist\vast_phase3_dynamic' } elseif ($Profile -eq 'phase3_smoke_vast') { 'dist\vast_phase3' } elseif ($isPhase3) { 'dist\kaggle_phase3' } elseif ($isPhase275) { 'dist\kaggle_phase275' } elseif ($isPhase25) { 'dist\kaggle_phase25' } elseif ($isPhase2) { 'dist\kaggle_phase2' } else { 'dist\kaggle' }
...
$driverName = if ($Profile -eq 'phase3_dynamic_smoke_vast') { 'vast_phase3_dynamic_driver.py' } elseif ($isPhase3) { 'kaggle_phase3_driver.py' } elseif ($isPhase2) { 'kaggle_phase2_driver.py' } else { 'kaggle_driver.py' }
